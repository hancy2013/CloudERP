angular.module('CloudERP', ['ngRoute', 'ngCookies', 'CloudERP.services'])
	.config(
		        ...
		        return {
		        	'request': function(config) {
		        		...
		        		if (isRestCall && angular.isDefined($rootScope.authToken)) {
		        			...
		        			if (CloudERPConfig.useAuthTokenHeader) {
...
services.factory('UserService', function($resource) {
	...
	return $resource(baseUrl+'/rest/user/:action', {},
			{
				authenticate: {
					method: 'POST',
...
services.factory('NewsService', function($resource) {
	...
	return $resource(baseUrl+'/rest/news/:id', {id: '@id'});
});
